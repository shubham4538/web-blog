...
function Terms() {
  return (
    <div className="px-10">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to WebBlog.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to WebBlog, accessible from{" "}
            <a
              href="https://daily-webblog.vercel.app"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://daily-webblog.vercel.app
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: shubhamsinghvi54@gmail.com</li>
      </ul>
    </div>
  );
}
